...
function Catalog({ searchParams }) {
    ...
    async function searchdata() {
        setLoading(true);
        const res = await AdvancedSearch(query, 'anime', selectedYear, null, null, genrevalue, status, sortbyvalue); // Pass all filters for correct API filtering
        setData(res?.media);
    ...
    }, [query, selectedYear, genrevalue, status, sortbyvalue]);
                    ...
                    <div className={styles.toptwo}>
                        <div className={styles.genres}>
                            ...
                            <Combobox value={genrevalue} onChange={setGenrevalue} multiple>
                                ...
                                <Transition
                                    ...
                                    afterLeave={() => setQuery("")}
                                >
                                    <Combobox.Options className="absolute z-50 mt-1 max-h-[220px] overflow-auto !rounded-lg bg-[#18181b] py-1 text-base shadow-lg ring-1 ring-black ring-opacity-5 focu[...]
                                                        ...
                                                        {({ selected, active }) => (
                                                            <>
                                                                ...
                                                                {selected ? (
                                                                    ...
                                                                    >
                                                                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true" data-slot="icon" className="h[...]
                                                                    </span>
                                                                ) : null}
                                                            </>
                                                        )}
                        ...
                        <div className={styles.catalogsort}>
                            ...
                            >
                                ...
                                <SelectItem value="NOT_YET_RELEASED">Not Yet Released</SelectItem>
