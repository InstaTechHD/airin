                        ...
                        <Link href={`/anime/info/${item.id}`} key={item.id}>
                            <div key={item.id} className={styles.carditem}>
                                <div className={styles.cardimgcontainer}>
                                    ...
                                    />
                                    {item.isAdult && (
                                        <div className={styles.adultIcon}>18+</div>
                                    )}
                                </div>
                                <div className="hidden xl:flex h-[85%] w-[100%] rounded absolute hover:bg-gradient-to-t from-black/90 to-transparent z-7 opacity-0 hover:opacity-100 transition-all duration-300 ease-in-out">
