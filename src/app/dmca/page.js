    ...
    <div>
      ...
      <div className="mx-auto w-[94%] lg:w-[80%]">
        ...
        <p className="mt-4 text-[#bdbdbd]">
          Makima.xyz is committed to respecting the intellectual property
        ...
        <p className="mt-4 text-[#bdbdbd]">
          None of the files listed on Makima.xyz are hosted on our servers. All
          ...
          to{" "}
          <Link href="mailto:contact@Makima.xyz" className="text-white">
            contact@Makima.xyz
          </Link>{" "}
